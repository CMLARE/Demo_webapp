...
xgboostWetDryWithBModelPath = "cmlare/trained_models/XGBOOST_2_layer_classification_with_B_as_dry.sav"
xgboostWetDryWithBModelPath = os.path.join(BASE_DIR, xgboostWetDryWithBModelPath)
